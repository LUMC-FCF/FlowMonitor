Tab_Import_BDLyric <- 
  tabItem(tabName = "importing_bdLyric",
    fluidRow(
      box(title = span(icon("file-import"), "Step 1: Import data from BD Lyric instruments"),
          background = "blue",
          width = 6,
          ...
          h4(strong("Click 'Import data' to import all files into the R environment")),
            actionButton("Importing_Button_BDLyric",
      ...
      box(title = span(icon("spinner"), "Step 2: Pre-Processing"),
          ...
          h4("This will merge all .csv files with 'PQC in 'their filename into one large table. Please note that this may take a few minutes. Please be patient as this may take a few minutes."),
          h4(strong("After pre-processing is complete, you can continue to plotting or exporting your data.")),
            actionButton("Pre_Processing_Button_BDLyric",
