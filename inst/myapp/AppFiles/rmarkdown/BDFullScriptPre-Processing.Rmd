...
file_path_BD<-"//vf-lumc-home.lumcnet.prod.intern/lumc-home$/ttak/MyDocs/BD CST files"
```
...
Tables.list<- lapply(File.List.BD_All, fread, header= TRUE, fill = TRUE, na.strings= "")
```

```{r convert data to a long table}
...
```{r reorder datatable}
Tables.list.long3<-Tables.list.long3 %>% arrange(Instrument,variable,Laser_Detector,Date_Time)
