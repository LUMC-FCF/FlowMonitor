...
#File.List.CytoflexSRT_All<-list.files(path = "C:/R/Beckman Coulter", pattern = ".csv", recursive=TRUE, full.names = TRUE)
...
TableFinal_CytoflexSRT<-TableFinal_CytoflexSRT[order("Instrument","variable","Laser_Detector","Date"),]
```
